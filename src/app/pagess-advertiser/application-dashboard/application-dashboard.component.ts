...
// const apiUrl = `http://192.168.8.100:8443/api/applications/by-email?email=${encodedEmail}`;

  this.http.get<ApplicationDto>("http://192.168.8.100:8443/api/applications/by-email/jane.doe%40example.com").subscribe({
