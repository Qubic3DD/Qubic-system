...
export class TabletService {
  ...
  const url = `http://196.168.8.29:8443/api/tablets/${tabletId}/assign/${userId}`;
...
getDrivers(search?: string): Observable<ApiResponse<DriverProfile[]>> {
    ...
    return this.http.get<ApiResponse<DriverProfile[]>>(`http://196.168.8.29:8443/profile/drivers`, { params })
      .pipe(
        catchError(this.handleError)
      );
  }
